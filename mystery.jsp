...
try {
    ...
    ResultSet rs;
    int counter=0;
    rs = stmt1.executeQuery("select top 8  COVER, PRICE, TITLE, AUTHOR,  DESCRIPTION_FIELD,  RANKING, BOOK_ID from BOOK where CATEGORY='Mystery' and AVAILABILITY>0 order by PUBLICATION_YEAR desc;");
    while ( rs.next() )
    {
