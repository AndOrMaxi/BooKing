...
out.println( "<h2>Exception: "+e.getMessage()+"</h2>" );
    ...
    out.println("<form action=\"orderResult.jsp\" method=post><center><table  class=\"title\" cellpadding=0 cellspacing=0 border=\"0\" >");
    ...
    out.println("<tr><td colspan =6 class=\"text3\"><hr/><center><b>PAYMENT WAY</b></center><br><input type=\"radio\" name=\"payWay\" value=\"cash\" checked>Cash<input type=\"radio\" name=\"payWay\" value=\"american_ex\">American Express");
    out.println("<input type=\"radio\" name=\"payWay\" value=\"maestro\">Maestro<input type=\"radio\" name=\"payWay\" value=\"master_card\">MasterCard");
    out.println("<input type=\"radio\" name=\"payWay\" value=\"paypal\">Paypal<input type=\"radio\" name=\"payWay\" value=\"visa\">Visa</tr>");
